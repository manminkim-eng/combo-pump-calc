# 🔴 겸용 펌프 용량 계산서 — 옥내소화전 + 스프링클러 · **Ver 5.0**

> **Developer MANMIN** | ㈜대성건축사사무소
> MANMIN WAP 디자인 통일 · 소방 계열 05.
...
```
옥내스프겸용_{공사명}_{YYYYMMDD}[_n].jpg     페이지당 1588 × 2246px (scale 2)
```
...
| **NFPC / NFTC 103** 스프링클러설비 | **제2025-25호 · 2026.3.1 시행** | 제4조 수원 `기준개수 × 1.6㎥` |

> **개정 영향 없음.** 102는 제3조16호 "난연재료" 정의 신설·제6조⑨ 보온재 단서,
> 103은 헤드 배치 개편이며 **양 기준 모두 제4조 수원은 개정되지 않았다.**
> 겸용 산정 방식(각 설비 수원의 합산·최대치 판정)에 변동이 없다.
